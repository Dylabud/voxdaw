...
export const DEFAULT_TRIGGER_MAPPINGS = [
  ...
  { id: 5,  trigger: 'right_middle_pinky',      destination: 'chord_minor_7'      },
  { id: 6,  trigger: 'right_middle_ring_pinky', destination: 'chord_major_7'      },
  { id: 7,  trigger: 'left_no_fingers',         destination: 'arp_off'            },
  { id: 8,  trigger: 'left_pinky',              destination: 'arp_octave'         },
  { id: 9,  trigger: 'left_middle',             destination: 'arp_simple'         },
  { id: 10, trigger: 'left_middle_ring',        destination: 'arp_complex'        },
  { id: 11, trigger: 'left_middle_ring_pinky',  destination: 'arp_complex_random' },
  { id: 12, trigger: 'left_middle_pinky',       destination: 'arp_simple_random'  },
  { id: 13, trigger: 'left_tilt_low',           destination: 'arp_rate_4n'        },
  { id: 14, trigger: 'left_tilt_mid',           destination: 'arp_rate_8n'        },
  { id: 15, trigger: 'left_tilt_high',          destination: 'arp_rate_16n'       },
];
